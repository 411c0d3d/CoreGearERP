...
/// <summary>
/// EF Core mapping configuration for PurchaseOrderLine.
/// </summary>
public class PurchaseOrderLineConfiguration : IEntityTypeConfiguration<PurchaseOrderLine>
{
    public void Configure(EntityTypeBuilder<PurchaseOrderLine> builder)
    {
        ...
        builder.OwnsOne(l => l.QuantityReceived, q =>
        {
            q.Property(x => x.Value).HasColumnName("qty_received").HasPrecision(18, 4).IsRequired();
            q.Property(x => x.UnitCode).HasColumnName("unit_code_received").HasMaxLength(10).IsRequired();
        });
